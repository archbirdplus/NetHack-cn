...
if not canceled then
	...
	considering case
		--set lastpos to offset of "/nethack-cndir" in mpath
		--set lastpos to lastpos + (length of "/nethack-cndir")
		--set rawpath to (get text 1 through lastpos of mpath) & "/recover.pl"
		--set safepath to the quoted form of rawpath
		set safepath to the quoted form of "/Library/Nethack/nethack-cndir/recover.pl"
	end considering
